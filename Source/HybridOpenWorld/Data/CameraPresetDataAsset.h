...
struct HYBRIDOPENWORLD_API FCameraPresetSettings
{
	...
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category="1. 카메라 기본",
	...
	// ─── Dynamic ──────────────────────────────
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category="1. 카메라 기본|Dynamic",
	...
	// ─── Static ───────────────────────────────
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category="1. 카메라 기본|Static",
	...
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category="2. 전환 및 래그",
	...
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category="3. 고급 설정|포스트 프로세스",
